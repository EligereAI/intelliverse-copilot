    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: `linear-gradient(160deg,
            #ff2a55 0%, #c4103a 25%, #8b0a28 55%, #4a0616 100%)`,
        }}
      />

      {/* ── Layer 2: Large radial bloom ── */}
      <div
        aria-hidden
        style={{
          position: "fixed", inset: 0, zIndex: 1,
          background: `radial-gradient(ellipse 80% 70% at 15% 5%,
            rgba(255,120,120,0.45) 0%, rgba(255,40,70,0.15) 40%, transparent 70%)`,
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background: `radial-gradient(ellipse 60% 50% at 95% 100%,
            rgba(30,0,8,0.7) 0%, transparent 65%)`,
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background: `linear-gradient(105deg,
            rgba(255,200,180,0.07) 0%, transparent 40%, rgba(60,0,15,0.25) 100%)`,
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(ellipse 100% 100% at 50% 50%, transparent 45%, rgba(20,0,6,0.55) 100%)",
          pointerEvents: "none",
        }}
      />
      ...
      >
        ...
        >
          <div style={{ borderRadius: 22, overflow: "hidden" }}>
            {/* ChatProvider must wrap both ChatFrame (which renders status) and ChatWindow */}
